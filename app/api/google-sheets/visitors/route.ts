...
// Google Sheets API endpoint for visitors
export async function POST(request: NextRequest) {
  try {
    ...
    const url = `https://sheets.googleapis.com/v4/spreadsheets/${SHEET_ID}/values/Visitors!A:I:append?valueInputOption=RAW&key=${API_KEY}`
